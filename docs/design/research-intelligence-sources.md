...
| Pre-run method consequence; claim-matched comparison; large-gain integrity | [jurgendn/agent-skills](https://github.com/jurgendn/agent-skills) | [`skills/research-experimentation/experiment-design/SKILL.md`](https://github.com/jurgendn/agent-skills/blob/main/skills/research-experimentation/experiment-design/SKILL.md); also inspected (not imported): `hypothesis-and-ablation-planner/SKILL.md`, `benchmark-and-baseline-selector/SKILL.md`, `statistical-testing-guide/SKILL.md`, `model-eval-error-analysis/SKILL.md`, `research-discovery/research-idea-stress-test/SKILL.md` | **unknown** — GitHub license API `null` 2026-09-14; no root `LICENSE`; SKILL.md files have **no** `license:` frontmatter | 2026-09-14 | Write method consequence before the run; match the comparison protocol to the claim kind; treat a surprising gain as a split/unit/metric question first | Restated in `experiment-thinking.md` §I–§J and §B; compact in-session notes in `experiment-design`; cites in `experiment-proposal.md` | no | **Use: abstract idea only.** Did not import their Skills, checklists, `stats.py`, `fit_scaling_law.py`, MINIMAL/SUGGESTED baseline chant, or install CLI |
