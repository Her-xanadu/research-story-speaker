...
description: Workhorse. Owns the full W2 run segment for a reserved EXP-ID (design/code/launch/hold-run/deliver) in an isolated context; can run in parallel. Do not spawn a second copy just to monitor someone else's job, interpret Story impact, or review.
model: inherit
---
