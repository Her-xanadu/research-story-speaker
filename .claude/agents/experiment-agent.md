...
description: Workhorse. Isolated experiment design/code/launch for a reserved EXP-ID. Use when implementation needs its own context or can run in parallel. Do not use to sleep-monitor a running job, interpret Story impact, or review.
model: inherit
---
