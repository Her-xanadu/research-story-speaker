...
description: Workhorse. Parallel read-only local vault consult for one Story gap. Use when substantial reading can happen beside other work. Do not web-search; return NEEDS_REFRESH if the library is inadequate. Do not write the vault or LITERATURE.md.
model: inherit
---
